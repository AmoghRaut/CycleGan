...
def train_fn(disc_H, disc_Z, gen_Z, gen_H, loader, opt_disc, opt_gen, l1, mse, d_scaler, g_scaler):
    ...
    for idx, (zebra, horse) in enumerate(loop):
        ...
        if idx % 200 == 0:
            save_image(fake_horse*0.5+0.5, f"/content/drive/MyDrive/CycleGAN/saved_images/horse_{idx}.png")
            save_image(fake_zebra*0.5+0.5, f"/content/drive/MyDrive/CycleGAN/saved_images/zebra_{idx}.png")
